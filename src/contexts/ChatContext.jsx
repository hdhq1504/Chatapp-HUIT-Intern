...
export const ChatProvider = ({ children }) => {
  ...
  const getChatHistory = (contactId) => {
    ...
    const chatKey = getChatKey(user.id, contactId);
  ...
  useEffect(() => {
    ...
    const handleNewMessage = (event) => {
      const { chatKey, message, senderId, receiverId } = event.detail;
